<template>
  <div class="p-2">
    ...
    >
      ...
      <el-table-column prop="account" label="帳號" width="300" />
      <el-table-column prop="name" label="姓名" min-width="250" />
...
// 資料清單
const list = ref([
  { id: 1, account: 'User01', name: '詹姆士', createdAt: '2023-09-12 11:00:00' },
  { id: 2, account: 'User02', name: '布萊恩', createdAt: '2023-12-16 13:00:00' },
  { id: 3, account: 'User03', name: '珍妮佛', createdAt: '2023-11-12 16:20:00' },
])
